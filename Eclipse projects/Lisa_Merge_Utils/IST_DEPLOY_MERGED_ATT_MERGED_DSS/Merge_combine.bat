...
set SOURCE_FOLDER=C:/stubbing/branches/b1603/1603_p1_Grid_On/1603_myATT_Validation_GridOn_merge/1603_myATT_Validation_GridOn_merge/VServices/MERGED/
...
for %%x in (
    ...
    echo Combining %%x
          C:/Lisa8.4/DevTest/bin/ServiceImageManager.exe --combine="%DESTINATION_FOLDER%%%x" --favor=target "%SOURCE_FOLDER%%%x"
    echo Done
)
