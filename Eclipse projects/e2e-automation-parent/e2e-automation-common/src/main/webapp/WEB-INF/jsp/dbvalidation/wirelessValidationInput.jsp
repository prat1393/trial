      ...
      <div class="row">
        ...
        <div class="col-md-6">
          ...
          <div class="box box-primary">
            ...
            <form:form action="wirelessvalidation" method="POST" modelAttribute="banlist" enctype="multipart/form-data">
              <div class="box-body">
              	<div class="form-group">
              	         	
                	<label>Select Release</label>
                	<form:select path="release" class="form-control select2" style="width: 100%;" id="releaseList" onchange="showWirelessDBApplication()">
