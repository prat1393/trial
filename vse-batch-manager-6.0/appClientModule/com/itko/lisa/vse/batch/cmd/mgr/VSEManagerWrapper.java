 ...
 * 
 */
public class VSEManagerWrapper {

	private static Logger				log			= Logger.getLogger(VSEManagerWrapper.class);
	...
	public static void main(String args[]) {
		...
		try {
			...
			VSEManagerWrapper managerWrapper = new VSEManagerWrapper(params);
	 ...
	 */
	public VSEManagerWrapper(LinkedList<String> args) {
...
//	    marInfo.setDeploymentParameter("AutoRestart", autoRestartObject ? "true" : "false");
	...
	private void checkACL() throws Exception {
		...
		if (reg.isSecurityEnabled()) {
			setUser(LisaSecurityManager.authenticateUserFromCommandLine(VSEManagerWrapper.commandLine));
		}
	}
